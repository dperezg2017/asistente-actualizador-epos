...
//        this.btnSiguiente.setDisable();
    ...
    private Collection<? extends PosActualizacion> insert() {
        ...
        return FXCollections.observableArrayList(
                new PosActualizacion(constante.SERVICIO_POS_PRINTMANAGER, estadoPosPrintManager, "", null, null, null, null, ubicacionActualizadorPrintManager),
    ...
    class TaskDetenerServicio extends SwingWorker<Void, Void> {
        ...
        public Void doInBackground() {
            ...
            list23.add(new PosActualizacion(constante.SERVICIO_POS_PRINTMANAGER, estadoPosPrintManager, constante.SERVICIO_POS_INICIADO_COMPONENTE,              this.detenerPrintmanager, this.respaldarPrintmanager, this.actualizarPrintmanager, this.iniciarPrintmanager, ubicacionActualizadorPrintManager));
